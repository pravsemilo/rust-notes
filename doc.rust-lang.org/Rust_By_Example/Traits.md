...
* There can result in namespace conflicts.
* Because each trait implementation gets its own `impl` block, there can't be conflicts.
* To eliminate runtime conflicts, we have to use Fully Qualified Syntax.
